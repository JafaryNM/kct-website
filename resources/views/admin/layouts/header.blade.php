<head>
    ...
    <link href="{{asset('admins/plugins/jquery-datatable/skin/bootstrap/css/dataTables.bootstrap.css')}}" rel="stylesheet">
    ...
    <link href="{{asset('admins/plugins/bootstrap-select/css/bootstrap-select.css')}}" rel="stylesheet" />
