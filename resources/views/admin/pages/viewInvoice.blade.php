                            ...
                            {{-- <div class="panel panel-bd"> --}}
                                <div id="printableArea" style=" background: #fff; padding: 30px;">
                                    <div class="panel-body">
                                        ...
                                        <div class="row" style="border-bottom:2px #333 solid;">
                                            <div class="col-sm-8 col-md-8" style="display: inline-block;">
                                                ...
                                                <address style="margin-top:10px; font-size: 12px; border: 1px solid #666; padding: 16px; width: 380px;">
                                                    <strong style="font-size: 20px; ">{{$invoices[0]->firstName}} {{$invoices[0]->lastName}}</strong><br>
                                                    <abbr><b>Address: </b></abbr>
                                                    {{$invoices[0]->address}}<br>
                                                    <abbr><b>Mobile: </b></abbr>
                                                    {{$invoices[0]->phoneNumber}}<br>
                                                    <abbr><b>Email: </b></abbr>
                                                    {{$invoices[0]->email}}
                                                </address>
                                            </div>
                                                ...
                                                <div style="margin-top:10px; font-size: 12px;">
                                                    <table style="width: 100%" class="invoice-address-table">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                            <td>Invoice No.</td>
                                                            <td>KCT/{{date("Y")}}/{{$invoices[0]->id}}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Invoice Date</td>
                                                            <td>{{$invoices[0]->created_at}}</td>
                                                        </tr>
                                                    </tbody></table>
                                                </div>
                                        ...
                                        <div class="table-responsive m-b-20">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="text-center-"><div><strong>{{$invoices[0]->year}} {{$invoices[0]->category}} {{$invoices[0]->productName}}</strong></div></td>
                                                        <td class="text-center"><div><strong>{{number_format($invoices[0]->engineNo, 0, '.', ',')}} CC</strong></div></td>
                                                        <td class="text-center"><div><strong>{{$invoices[0]->color}}</strong></div></td>
                                                        <td class="text-center"><div><strong>{{number_format($invoices[0]->milles, 0, '.', ',')}} KM</strong></div></td>
                                                        <td class="text-center"><div><strong>{{number_format($invoices[0]->firstInstallment, 0, '.', ',')}}</strong></div></td>
                                                        <td class="text-center"><div><strong>{{number_format($invoices[0]->secondInstallment, 0, '.', ',')}}</strong></div></td>
                                                        <td align="right">{{number_format($invoices[0]->sellingPrice, 0, '.', ',')}}</td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-4 pull-right" style="float: right">
                                                <table class="table">                                                                                                           <tbody><tr>
                                                        ...
                                                        <td class="text-right grand_total">{{number_format($invoices[0]->sellingPrice, 0, '.', ',')}}</td>
                                                    </tr>
                                                    <tr>
                                    ...
                                    <div class="panel-footer text-left no-print" style="padding: 10px 16px; border: 1px solid #eee;">
                                        ...
                                        <a href="{{asset('paySlip/'.$invoices[0]->paySlip)}}">{{$invoices[0]->paySlip}}</a>
                                    </div>

                                    <div class="panel-footer text-left no-print" style="padding: 10px 16px;">
                                        <a style="float: left;" class="btn btn-danger" href="{{url('admins/invoice_lists')}}">Go back</a>
